...
pio.templates.default.layout.font.family = "Microsoft YaHei"
        ...
        with st.spinner("计算预测结果..."):
            try:
                ...
                <div style="text-align: center; margin: -0.2rem 0 0.3rem 0;">
                    <span style="font-size: 1.1rem; font-family: 'Microsoft YaHei', sans-serif; color: {risk_color}; font-weight: bold;">
                        {risk_category}
                    </span>
                </div>
                """, unsafe_allow_html=True)
                ...
                <div class="progress-container">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 0.2rem;">
                        <div style="text-align: center; width: 48%;">
                            <div style="font-size: 0.9rem; font-weight: bold; color: #1E3A8A; font-family: 'Microsoft YaHei', sans-serif;">三年生存概率</div>
                            <div style="font-size: 1.1rem; font-weight: bold; color: #10B981; font-family: 'Microsoft YaHei', sans-serif;">{survival_probability:.1f}%</div>
                        </div>
                        <div style="text-align: center; width: 48%;">
                            <div style="font-size: 0.9rem; font-weight: bold; color: #1E3A8A; font-family: 'Microsoft YaHei', sans-serif;">三年死亡风险</div>
                            <div style="font-size: 1.1rem; font-weight: bold; color: #EF4444; font-family: 'Microsoft YaHei', sans-serif;">{death_probability:.1f}%</div>
                        </div>
                    </div>
                </div>
                """, unsafe_allow_html=True)
                ...
                try:
                    with st.spinner("正在生成SHAP解释图..."):
                        ...
                        for ax in plt.gcf().get_axes():
                            # 设置坐标轴标签字体
                            if ax.xaxis.label:
                                ax.xaxis.label.set_fontproperties('Microsoft YaHei')
                            if ax.yaxis.label:
                                ax.yaxis.label.set_fontproperties('Microsoft YaHei')
                            ...
                            for child in ax.get_children():
                                if isinstance(child, mpl.text.Text):
                                    child.set_fontproperties('Microsoft YaHei')
...
# 添加页脚说明
st.markdown("""
<div class="disclaimer" style="font-family: 'Microsoft YaHei', sans-serif;">
